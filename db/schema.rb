...
ActiveRecord::Schema.define(:version => 20110713050822) do
  ...
  create_table "bookreceipts_bkp", :id => false, :force => true do |t|
  ...
  create_table "regionaltitles", :force => true do |t|
    t.integer  "title_id",     :precision => 38, :scale => 0
    t.string   "title"
    ...
    t.string   "currency"
    t.integer  "no_of_pages",  :precision => 38, :scale => 0
